...
5. [Future Works: fabric-samples](#future-works-fabric-samples)
...
Another key point of this documentation is provide pointers to strategic parts of the
fabric code that are most relevant to the integration.
