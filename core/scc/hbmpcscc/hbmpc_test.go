...
func tempDir(t *testing.T, stem string) string {
	path, err := ioutil.TempDir("", "hbmpcscc-"+stem)
...
func TestQueryGetChainInfo(t *testing.T) {
	...
	prop := resetProvider(resources.Hscc_GetChainInfo, chainid, &peer2.SignedProposal{}, nil)
...
func TestQueryGetTransactionByID(t *testing.T) {
	...
	prop := resetProvider(resources.Hscc_GetTransactionByID, chainid, &peer2.SignedProposal{}, nil)
	res := stub.MockInvokeWithSignedProposal("1", args, prop)
...
func TestQueryGetBlockByNumber(t *testing.T) {
	...
	prop := resetProvider(resources.Hscc_GetBlockByNumber, chainid, &peer2.SignedProposal{}, nil)
	res := stub.MockInvokeWithSignedProposal("1", args, prop)
...
func TestQueryGetBlockByHash(t *testing.T) {
	...
	prop := resetProvider(resources.Hscc_GetBlockByHash, chainid, &peer2.SignedProposal{}, nil)
	res := stub.MockInvokeWithSignedProposal("1", args, prop)
...
func TestQueryGetBlockByTxID(t *testing.T) {
	...
	prop := resetProvider(resources.Hscc_GetBlockByTxID, chainid, &peer2.SignedProposal{}, nil)
	res := stub.MockInvokeWithSignedProposal("1", args, prop)
...
func TestFailingAccessControl(t *testing.T) {
	...
	resetProvider(resources.Hscc_GetChainInfo, chainid, sProp, errors.New("Failed access control"))
	...
	sProp.Signature = sProp.ProposalBytes
	// Set the ACLProvider to have a failure
	resetProvider(resources.Hscc_GetBlockByNumber, chainid, sProp, errors.New("Failed access control"))
	res = stub.MockInvokeWithSignedProposal("2", args, sProp)
	...
	sProp.Signature = sProp.ProposalBytes
	// Set the ACLProvider to have a failure
	resetProvider(resources.Hscc_GetBlockByHash, chainid, sProp, errors.New("Failed access control"))
	res = stub.MockInvokeWithSignedProposal("2", args, sProp)
	...
	sProp.Signature = sProp.ProposalBytes
	// Set the ACLProvider to have a failure
	resetProvider(resources.Hscc_GetBlockByTxID, chainid, sProp, errors.New("Failed access control"))
	res = stub.MockInvokeWithSignedProposal("2", args, sProp)
	...
	sProp.Signature = sProp.ProposalBytes
	// Set the ACLProvider to have a failure
	resetProvider(resources.Hscc_GetTransactionByID, chainid, sProp, errors.New("Failed access control"))
	res = stub.MockInvokeWithSignedProposal("2", args, sProp)
	assert.Equal(t, int32(shim.ERROR), res.Status, "Hscc_GetTransactionByID must fail: %s", res.Message)
	assert.Contains(t, res.Message, "Failed access control")
	// assert that the expectations were met
	mockAclProvider.AssertExpectations(t)
}
...
func TestQueryNonexistentFunction(t *testing.T) {
	...
	prop := resetProvider("hbmpcscc/GetBlocks", chainid, &peer2.SignedProposal{}, nil)
	res := stub.MockInvokeWithSignedProposal("1", args, prop)
